...
async function getSelectedFacilityAndRole() {
  const cookieStore = cookies(); // ✅ Get the cookies promise
  const facilityCookie = await cookieStore.get("selectedFacility");
  const roleCookie = await cookieStore.get("selectedRole");

  return {
    selectedFacility: facilityCookie ? JSON.parse(facilityCookie.value) : null,
    selectedRole: roleCookie ? roleCookie.value : "No Role",
  };
}
...
export default async function DoctorLayout({
  ...
  const { selectedFacility, selectedRole } = await getSelectedFacilityAndRole();
            ...
            <div className="flex gap-6 items-center">
              ...
              <div className="flex mr-2 gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuLabel>My Roles</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem>{selectedRole}</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </div>
            </div>
