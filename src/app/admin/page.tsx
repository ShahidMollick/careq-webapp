...
export default function QueueManagement() {
  ...
  const confirmCancel = async () => {
    ...
    try {
      ...
      const cancelUrl = `http://localhost:5002/appointments/cancelappointment/${scheduleId}/${patientToCancel.appointmentId}`;
      ...
      if (socket?.connected) {
        ...
        await fetchAppointments(scheduleId);
      }
    } catch (error) {
  ...
  const autoSchedulePatient = async (patient: Patient) => {
    ...
    try {
      ...
      await axios.patch(
        `https://9b94-203-110-242-40.ngrok-free.app/appointments/autoreschedule/${scheduleId}/${patient.appointmentId}`
      );
