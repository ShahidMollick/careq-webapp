...
export default function QueueManagement() {
  ...
  const skipPatient = async (scheduleId:string, appointmentId: string) => {
    ...
    try {
      ...
      // Fixed API endpoint structure - sending scheduleId in request body
      await axios.patch(
      ...
      alert("Failed to skip patient. Please try again.");
    }
  };
                                  ...
                                  <div className="flex items-center">
                                    <DropdownMenu>
                                      ...
                                      <DropdownMenuItem onClick={() => {
                                        ...
                                        if (!scheduleId || !patient?.appointmentId) {
                                          console.error("Cannot skip patient: Missing scheduleId or appointmentId", {
                                            scheduleId,
                                            patientId: patient?.id,
                                        ...
                                        skipPatient(scheduleId, patient.appointmentId);
                                      }}>
                                        Skip Patient
                                      </DropdownMenuItem>
                                      </DropdownMenuContent>
                    ...
                    <Button 
                        ...
                        onClick={() => {
                          if (currentPatient?.appointmentId) {
                            skipPatient(scheduleId, currentPatient.appointmentId);
                          } else {
...
//   // Make sure this matches your NestJS `@Controller('appointments')`
//   // If it's `@Controller('appointments')`, your final route is /appointments/...  
//   const scheduleId = "ad265dc5-96b7-4dcd-b14b-1eda04f6ad0e";
...
//         console.warn(
//           `Patient ${patient.name} (ID: ${patient.id}) missing appointmentId. Using ID as fallback`
//         );
//         return { ...patient, appointmentId: patient.id }; // fallback
//       }
//       return patient;
//     });
...
//   /**
//    * A quick helper just to manually fetch appointments (optional).
//    */
//   const fetchAppointments = async (scheduleId: string) => {
//     setLoading(true);
//     setError("");
...
//   /**
//    * Verifies the patient by phone number.
//    */
//   const verifyPatient = async () => {
//     setLoading(true);
//     setError("");
...
//         // If the API returns a date with T, we can trim it
//         const formattedDob = patient.dob ? patient.dob.split("T")[0] : "";

//         // Pre-fill the form with the verified patient info
//         setNewPatient({
//           ...newPatient,
//           name: patient.name,
//           gender: patient.gender,
...
//   /**
//    * Add or create a new patient, then book an appointment.
//    */
//   const addPatient = async () => {
//     const patientData = {
//       phone: newPatient.phone,
...
//     try {
//       let patient;
//       console.log("verifiedPatient:", verifiedPatient);

//       // 1) If verified, use that. Otherwise, create new.
//       if (verifiedPatient) {
...
//       // 2) Book an appointment for this scheduleId
//       const source = "web"; 
//       console.log("patientId :", patient.id);
...
//       // Optional: alert or update state
//       // ...
//     } catch (error) {
//       console.error("❌ Error adding patient:", error);
//       alert("Failed to add patient.");
...
//   /**
//    * Cancel the appointment in local UI (demo only).
//    */
//   const cancelAppointment = (patient: Patient) => {
//     setSelectedPatientForCancel(patient);
//     setCancelDialogOpen(true);
...
//   /**
//    * ⚠️ The main function for skipping a patient
//    */
//   const skipPatient = async (scheduleId: string, appointmentId: string) => {
//     try {
//       // Let's log them out so we can confirm EXACTLY what’s being passed.
//       console.log("== skipPatient function START ==");
//       console.log("scheduleId:", scheduleId);
//       console.log("appointmentId:", appointmentId);

//       if (!scheduleId || !appointmentId) {
//         console.error(
//           "Cannot skip patient: Missing scheduleId or appointmentId",
...
//       // Construct the final URL we are calling:
//       const skipUrl = `https://9b94-203-110-242-40.ngrok-free.app/appointments/skip/${scheduleId}/${appointmentId}`;
//       console.log("Skip URL:", skipUrl);

//       await axios.patch(skipUrl);

//       console.log("📡 Emitting WebSocket update after skipping patient...");
//       socket?.emit("fetchAppointments", scheduleId);
//       console.log("== skipPatient function END ==");
//     } catch (err) {
//       console.error("Error skipping patient:", err);
//       alert("Failed to skip patient. Please try again.");
//     }
...
//   /**
//    * Example: Start serving next patient
//    */
//   const handleStartServing = async (scheduleId: string) => {
//     try {
//       await axios.patch(
...
//     } catch (err) {
//       console.error("Error processing patients:", err);
//       setError("Failed to update patient status and call next patient.");
//     }
//   };

//   /**
//    * Example: Finish serving current patient
//    */
//   const handleFinishServing = async (scheduleId: string) => {
//     try {
//       await axios.patch(
...
//   /**
//    * Example: If no one is serving, call next patient
//    */
//   const handleFinish = async (scheduleId: string) => {
//     try {
//       await axios.patch(
...
//     ? currentPatient.queueNumber
//     : lastCompletedPatient
//     ? lastCompletedPatient.queueNumber
//     : "-";
...
//                                           onClick={() => {
//                                             console.log(
//                                               "=== Attempting to skip a patient ==="
//                                             );
//                                             console.log(
//                                               "scheduleId (outer scope):",
//                                               scheduleId
//                                             );
//                                             console.log(
//                                               "appointmentId from patient:",
...
//                             </div>
//                           </div>
//                           <Button variant="default" onClick={() => autoSchedulePatient(patient)}>
//                             Auto Schedule
//                           </Button>
//                         </div>
//                       ))}
...
//                           <p className="text-sm text-muted-foreground">
//                             Info about online appointments...
//                           </p>
//                         </div>
//                         <Switch
