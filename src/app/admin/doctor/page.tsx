...
=======
import { useState, useEffect } from "react";
>>>>>>> ffe730dd2125e409cc810a9172a096ebc3ee03b3
      ...
      switch (status) {
        ...
        case "USER_FOUND_BUT_NOT_DOCTOR":
          toast({
            ...
            about: "The user exists, but no doctor profile found.",
            action: (
...
>>>>>>> ffe730dd2125e409cc810a9172a096ebc3ee03b3
        ...
        default:
          toast({
            title: "Unknown error",
            about: "An unknown error occurred while validating the doctor.",
            action: <ToastAction altText="Try again">Try again</ToastAction>,
          });
      }
    } catch (error) {
...
>>>>>>> ffe730dd2125e409cc810a9172a096ebc3ee03b3
      ...
      if (response.status === 201 || response.status === 200) {
        ...
        toast({
          title: "Success",
          about: "Doctor profile created successfully",
        });
      }
    } catch (err) {
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <Dialog>
              ...
              <DialogContent className="min-w-[530px] max-w-[30%] max-h-[85%] overflow-y-auto scrollbar-hide">
                {!showDoctorForm && (
                  <DialogHeader className="flex flex-col align-items-center justify-content-center">
                    ...
                    <p className="text-sm text-gray-500">
                      Invite doctors to join your clinic by sharing the link
                      below. They'll be able to create an account and get
                      started right away.
                    </p>
                  </DialogHeader>
                )}
                            ...
                            <div className="flex items-center flex-col gap-6">
                              ...
                              <div className="flex justify-center items-end gap-4 p-0 pt-0">
                                <div className="h-30 w-30 relative rounded-full">
                                  <Image
                                    src={profileImage || "/docotr-avatar.webp"}
                                    alt="profile"
                                    height={120}
                                    width={120}
                                    className="rounded-full bg-primary-accent border-8 border-white border-spacing-0 z-10"
                                  />
                                  <Button
                                    variant="outline"
                                    ...
                                    <div className="flex gap-4 w-full">
                                      <div className="flex flex-col gap-2 w-1/2">
                                        ...
                                        <Input
                                          ...
                                          readOnly={prefilled}
                                          style={{
                                            backgroundColor: prefilled
                                              ? "#f3f4f6"
                                              : "", // Light gray background when prefilled 
                                          }}
                                        />
                                      </div>
                                      <div className="flex flex-col gap-2 w-1/2">
                                  ...
                                  <div className="w-full flex flex-row gap-2 items-center">
                                    ...
                                    <div className="w-2/3 flex flex-col max-w-sm gap-2">
                                      ...
                                      <Input
                                        ...
                                        style={{
                                          backgroundColor:
                                            cases && prefilled ? "#f3f4f6" : "", // Light gray background when prefilled
                                        }}
                                      />
                                    </div>
                                ...
                                >
                                  ...
                                  <DialogContent>
                                    ...
                                    <p className="mb-4 text-sm">
                                      You have made the following changes to
                                      your profile:
                                    </p>
...
=======
                        ...
                        >
                          {step === 1 ? "Next" : "Invite Doctor"}
                          <div>
                         { step === 1 ? <ArrowRight></ArrowRight> : <Send/>}
                  ...
                  <TableRow key={doctor.id}>
                    <TableCell>
                      <Checkbox
                        ...
                        checked={selectedDoctors.includes(Number(doctor.id))}
                        onCheckedChange={() =>
                          toggleSelectDoctor(Number(doctor.id))
                        }
                      />
                    </TableCell>
                    <TableCell>{index + 1}</TableCell>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <Sheet>
                            ...
                            <SheetContent>
                              <SheetHeader>
                                <SheetTitle>{doctor.user.name}'s Profile</SheetTitle>
                              </SheetHeader>
                              <div className="flex flex-col my-4 w-full items-center">
                                <Image
                                  src="/docotr-avatar.webp"
                          ...
                          <Button
                            variant="destructive"
                            onClick={() =>
                              handleDeleteDoctor(Number(doctor.id))
                            }
                          >
                            Delete
                          </Button>
